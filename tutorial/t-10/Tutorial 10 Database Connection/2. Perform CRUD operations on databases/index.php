...
<body>
    ...
    <input type="submit" name="sub" class="btn" value="Insert">
    </form>
        <a href="update.php"><input type="submit" name="update" class="btn" value="Update" style="position: absolute;left: 250px;top: 632px;"></a>
